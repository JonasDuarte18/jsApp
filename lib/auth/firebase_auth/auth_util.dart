...
DocumentReference? get currentUserReference =>
    loggedIn ? FuncionariosRecord.collection.doc(currentUser!.uid) : null;

FuncionariosRecord? currentUserDocument;
final authenticatedUserStream = FirebaseAuth.instance
    ...
    .switchMap(
      (uid) => uid.isEmpty
          ? Stream.value(null)
          : FuncionariosRecord.getDocument(
                  FuncionariosRecord.collection.doc(uid))
              .handleError((_) {}),
    )

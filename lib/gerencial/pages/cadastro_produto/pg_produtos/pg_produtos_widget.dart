...
import '/gerencial/pages/cadastro_produto/pop_up_cadastro_produto/pop_up_cadastro_produto_widget.dart';
import '/gerencial/pages/cadastro_produto/ver_produto_componente/ver_produto_componente_widget.dart';
...
import 'pg_produtos_model.dart';
export 'pg_produtos_model.dart';

class PgProdutosWidget extends StatefulWidget {
  const PgProdutosWidget({super.key});

  @override
  State<PgProdutosWidget> createState() => _PgProdutosWidgetState();
}

class _PgProdutosWidgetState extends State<PgProdutosWidget> {
  late PgProdutosModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PgProdutosModel());
                        ...
                        child: StreamBuilder<List<ProdutoRecord>>(
                          stream: queryProdutoRecord(
                            queryBuilder: (produtoRecord) =>
                                produtoRecord.orderBy('codProduto'),
                          ),
                                              ...
                                              Align(
                                                ...
                                                child: Builder(
                                                  builder: (context) => InkWell(
                                                    ...
                                                    child:
                                                        VerProdutoComponenteWidget(
                                                      key: Key(
                                                          'Keydxz_${produtosIndex}_of_${produtos.length}'),
                                                    ),
                                                  ),
                                                ),
                                              ),
